...
export function TrabalheConosco() {
  ...
  return (
    <>
      <title>Trabalhe Conosco - Portal Economico Mundial</title>
      ...
      <section className="max-w-[1100px] mx-auto px-4 py-8 sm:py-10 lg:py-12">
        <header className="mb-8 sm:mb-10">
          ...
          <p className="text-sm text-[#6b6b6b] mt-3 max-w-2xl">
            Quer fazer parte do PEM? Conte sobre você e envie links para portfolio ou currículo.
          </p>
        </header>
