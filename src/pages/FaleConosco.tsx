...
export function FaleConosco() {
  ...
  return (
    <>
      <title>Fale Conosco - Portal Economico Mundial</title>
      ...
      <section className="max-w-[1100px] mx-auto px-4 py-8 sm:py-10 lg:py-12">
        <header className="mb-8 sm:mb-10">
          ...
          <p className="text-sm text-[#6b6b6b] mt-3 max-w-2xl">
            Envie dúvidas, sugestoes ou parcerias. Nosso time responde o mais rapido possivel.
          </p>
        </header>

        <section className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6 lg:gap-10">
          <form onSubmit={handleSubmit} className="bg-white border border-[#e5e5e5] rounded-2xl p-5 sm:p-8 shadow-[0_20px_60px_-40px_rgba(0,0,0,0.35)]">
          ...
          <aside className="bg-[#111111] text-white rounded-2xl p-5 sm:p-7 h-fit">
            ...
            <p className="text-sm text-white/70 mt-2">
              Atendimento em dias úteis, 9h às 18h. Resposta média em ate 1 dia útil.
            </p>
