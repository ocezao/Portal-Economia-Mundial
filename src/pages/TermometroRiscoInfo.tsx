...
export function TermometroRiscoInfo() {
  return (
    <>
      <title>Termometro de Risco - {APP_CONFIG.brand.name}</title>
      <meta
        name="description"
        content="Entenda como o termometro de risco e calculado e como interpretar os niveis."
      />

      <header className="bg-[#111111] text-white py-16">
        <section className="max-w-[960px] mx-auto px-4">
          <h1 className="text-3xl md:text-5xl font-black mb-4">Termometro de Risco</h1>
