                ...
                <section className="flex items-center justify-between p-4 bg-[#f0fdf4] border border-[#86efac] rounded-lg">
                  <section className="flex items-center gap-3">
                    ...
                    <section>
                      ...
                      <p className="text-xs text-[#6b6b6b]">
                        {typeof navigator !== 'undefined' && navigator.userAgent.includes('Windows') ? 'Windows' : 
                         typeof navigator !== 'undefined' && navigator.userAgent.includes('Mac') ? 'MacOS' : 'Linux'} • 
                        {typeof navigator !== 'undefined' && navigator.userAgent.includes('Chrome') ? ' Chrome' : 
                         typeof navigator !== 'undefined' && navigator.userAgent.includes('Firefox') ? ' Firefox' : ' Navegador'}
                      </p>
                    </section>
                  </section>
