...
export const metadata: Metadata = {
  title: `Mapa de Tensões - ${APP_CONFIG.brand.name}`,
  description: 'Entenda o que é o mapa de tensões e como interpretamos os níveis.',
  alternates: { canonical: `${getSiteUrl()}/mapa-de-tensoes/` },
  openGraph: {
    type: 'website',
    url: `${getSiteUrl()}/mapa-de-tensoes/`,
    title: `Mapa de Tensões - ${APP_CONFIG.brand.name}`,
    description: 'Entenda o que é o mapa de tensões e como interpretamos os níveis.',
...
export default function MapaDeTensoesPage() {
  const siteUrl = getSiteUrl();
  const breadcrumbJsonLd = generateBreadcrumbJsonLd([
    { name: 'Home', url: `${siteUrl}/` },
    { name: 'Mapa de Tensoes', url: `${siteUrl}/mapa-de-tensoes/` },
  ]);

  return (
    <>
      <JsonLd id="jsonld-breadcrumb-mapa" data={breadcrumbJsonLd} />

      <header className="bg-[#111111] text-white py-16">
        <section className="max-w-[960px] mx-auto px-4">
          <h1 className="text-3xl md:text-5xl font-black mb-4">Mapa de Tensões</h1>
