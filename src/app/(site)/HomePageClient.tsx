      ...
      <section className="max-w-[1280px] mx-auto px-4 py-6">
          ...
          <aside className="mb-8 p-4 bg-[#c40000] text-white rounded-lg">
            <header className="flex items-center gap-2 mb-2">
              ...
              <time className="text-xs opacity-90">
                {new Date(breaking[0].publishedAt).toLocaleTimeString('pt-BR', {
                  hour: '2-digit',
                  minute: '2-digit',
                })}
              </time>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
          <article className="p-5 border rounded-xl bg-white">
            ...
            <p className="text-sm text-[#6b6b6b] mb-4">Resumo rápido com o que mais importa agora.</p>
          ...
          <article className="p-5 border rounded-xl bg-white">
            ...
            <p className="text-sm text-[#6b6b6b] mb-4">Qual tema você quer ver mais esta semana?</p>
