/**
 * ConfiguraÃ§Ãµes do UsuÃ¡rio - VersÃ£o Aprimorada
 * Idioma, privacidade, seguranÃ§a, aparÃªncia e gerenciamento de dados
 */
...
export default function ConfiguracoesPage() {
  ...
  const exportData = (format: 'json' | 'csv') => {
    ...
    if (format === 'json') {
      ...
      a.href = url;
      a.download = `cin-dados-${user?.id}-${Date.now()}.json`;
      ...
      // CSV export
      const csvRows = [
        ['Tipo', 'ID', 'Data', 'TÃ­tulo/DescriÃ§Ã£o'],
        ['UsuÃ¡rio', user?.id || '', user?.createdAt || '', user?.name || ''],
        ...(data.bookmarks || []).map((b) => ['Favorito', b.articleSlug, b.bookmarkedAt, b.title]),
        ...(data.history || []).map((h) => ['HistÃ³rico', h.articleSlug, h.readAt, h.title]),
      ];
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = `cin-dados-${user?.id}-${Date.now()}.csv`;
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
      URL.revokeObjectURL(url);
  ...
  const clearAllData = async () => {
    // Limpar dados sensÃ­veis do sessionStorage
    secureStorage.clear();
    
    // Limpar dados do usuÃ¡rio do localStorage (apenas nÃ£o-sensÃ­veis)
    ...
    // Usa publicStorage que tem proteÃ§Ã£o SSR
    Object.values(STORAGE_KEYS).forEach(key => {
      // Apenas remove se NÃƒO for uma chave sensÃ­vel
  ...
  const resetSettings = () => {
    ...
    toast.success('ConfiguraÃ§Ãµes restauradas para o padrÃ£o');
  };
  ...
  const copySessionInfo = () => {
    ...
    toast.success('InformaÃ§Ãµes copiadas para a Ã¡rea de transferÃªncia');
  };
    ...
    <>
      <main className="max-w-[1024px] mx-auto px-4 py-6 sm:py-8">
        <header className="mb-6 sm:mb-8 flex items-start justify-between">
          <section>
            <h1 className="text-2xl sm:text-3xl font-bold text-[#111111]">ConfiguraÃ§Ãµes</h1>
            <p className="text-sm sm:text-base text-[#6b6b6b] mt-1">
              Personalize sua experiÃªncia no portal
            </p>
          </section>
          {hasChanges && (
            <Button 
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-2">
            ...
            <TabsTrigger value="conteudo" className="gap-2">
              ...
              <span className="hidden sm:inline">ConteÃºdo</span>
            </TabsTrigger>
          ...
          <TabsContent value="geral" className="space-y-6">
            ...
            <article className="bg-white border border-[#e5e5e5] rounded-lg p-4 sm:p-6">
              <header className="flex items-center gap-3 mb-4">
                ...
                <section>
                  <h2 className="text-lg font-semibold text-[#111111]">Idioma e RegiÃ£o</h2>
                  <p className="text-xs text-[#6b6b6b]">Configure o idioma de exibiÃ§Ã£o do conteÃºdo</p>
                </section>
              </header>
              ...
              <ul className="space-y-4">
                <li>
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    />
                    <section>
                      <p className="text-sm font-medium text-[#111111]">Reduzir animaÃ§Ãµes</p>
                      <p className="text-xs text-[#6b6b6b]">
                        Desativa animaÃ§Ãµes e transiÃ§Ãµes para melhor acessibilidade.
                      </p>
                    </section>
                  </label>
                </li>
                <li>
                  <label className="flex items-start gap-3">
                    ...
                    <section>
                      <p className="text-sm font-medium text-[#111111]">NavegaÃ§Ã£o por teclado</p>
                      <p className="text-xs text-[#6b6b6b]">
            ...
            <article className="bg-white border border-[#e5e5e5] rounded-lg p-4 sm:p-6">
              <header className="flex items-center gap-3 mb-4">
                ...
                <section>
                  <h2 className="text-lg font-semibold text-[#111111]">SessÃ£o Atual</h2>
                  <p className="text-xs text-[#6b6b6b]">InformaÃ§Ãµes sobre sua sessÃ£o</p>
                </section>
              </header>
              ...
              <section className="space-y-3">
                <section className="flex items-center justify-between p-3 bg-[#f8fafc] rounded-lg">
                  <section>
                    <p className="text-sm font-medium text-[#111111]">ID da SessÃ£o</p>
                ...
                <section className="flex items-center justify-between p-3 bg-[#f8fafc] rounded-lg">
                  <section>
                    <p className="text-sm font-medium text-[#111111]">Ãšltimo login</p>
                    <p className="text-xs text-[#6b6b6b]">
                ...
                <section className="flex items-center justify-between p-3 bg-[#f8fafc] rounded-lg">
                  <section>
                    ...
                    <p className="text-xs text-[#6b6b6b] capitalize">
                      {user?.role === 'admin' ? 'Administrador' : 'PadrÃ£o'}
                    </p>
                  </section>
                </section>
              </section>
            ...
            <article className="bg-white border border-[#e5e5e5] rounded-lg p-4 sm:p-6">
              <header className="flex items-center gap-3 mb-6">
                ...
                <section>
                  ...
                  <p className="text-xs text-[#6b6b6b]">EspaÃ§amento entre elementos</p>
                </section>
              </header>
              
              <section className="space-y-3">
                {[
                  { value: 'compact', label: 'Compacto', desc: 'Menos espaÃ§amento, mais conteÃºdo visÃ­vel' },
                  { value: 'comfortable', label: 'ConfortÃ¡vel', desc: 'EquilÃ­brio entre conteÃºdo e espaÃ§amento' },
                  { value: 'spacious', label: 'EspaÃ§oso', desc: 'Mais espaÃ§amento, leitura relaxada' },
                ].map((density) => (
                  <label
                    key={density.value}
          ...
          <TabsContent value="notificacoes" className="space-y-6">
            <article className="bg-white border border-[#e5e5e5] rounded-lg p-4 sm:p-6">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center justify-between">
                  <section>
                    <p className="text-sm font-medium text-[#111111]">Newsletter diÃ¡ria</p>
                    <p className="text-xs text-[#6b6b6b]">Resumo matinal com as notÃ­cias mais importantes</p>
                  </section>
                  <Switch
                ...
                <li className="flex items-center justify-between">
                  <section>
                    <p className="text-sm font-medium text-[#111111]">Alertas de notÃ­cias urgentes</p>
                    <p className="text-xs text-[#6b6b6b]">NotificaÃ§Ãµes sobre eventos importantes em tempo real</p>
                  </section>
                  <Switch
                ...
                <li className="flex items-center justify-between">
                  <section>
                    ...
                    <p className="text-xs text-[#6b6b6b]">MovimentaÃ§Ãµes importantes nos mercados financeiros</p>
                  </section>
                  <Switch
            ...
            <article className="bg-white border border-[#e5e5e5] rounded-lg p-4 sm:p-6">
              <header className="flex items-center gap-3 mb-4">
                ...
                <section>
                  ...
                  <p className="text-xs text-[#6b6b6b]">NotificaÃ§Ãµes no navegador e dispositivos</p>
                </section>
              </header>
              ...
              <ul className="space-y-4">
                <li className="flex items-center justify-between">
                  <section>
                    <p className="text-sm font-medium text-[#111111]">NotificaÃ§Ãµes push</p>
            ...
            <article className="bg-white border border-[#e5e5e5] rounded-lg p-4 sm:p-6">
              <header className="flex items-center gap-3 mb-4">
                ...
                <section>
                  ...
                  <p className="text-xs text-[#6b6b6b]">Controle como seus dados sÃ£o usados</p>
                </section>
              </header>
              ...
              <ul className="space-y-4">
                <li className="flex items-center justify-between">
                  <section>
                    <p className="text-sm font-medium text-[#111111]">PersonalizaÃ§Ã£o de conteÃºdo</p>
                    <p className="text-xs text-[#6b6b6b]">Permite que usemos seu histÃ³rico para recomendar artigos</p>
                  </section>
                  <Switch
                ...
                <li className="flex items-center justify-between">
                  <section>
                    <p className="text-sm font-medium text-[#111111]">HistÃ³rico de leitura</p>
                    <p className="text-xs text-[#6b6b6b]">Salvar histÃ³rico de artigos lidos</p>
                  </section>
                  <Switch
                ...
                <li className="flex items-center justify-between">
                  <section>
                    <p className="text-sm font-medium text-[#111111]">Cookies analÃ­ticos</p>
                    <p className="text-xs text-[#6b6b6b]">Ajuda-nos a melhorar o site com dados anÃ´nimos</p>
                  </section>
                  <Switch
            ...
            <article className="bg-white border border-[#e5e5e5] rounded-lg p-4 sm:p-6">
              <header className="flex items-center gap-3 mb-4">
                ...
                <section>
                  ...
                  <p className="text-xs text-[#6b6b6b]">Gerenciar preferÃªncias de cookies</p>
                </section>
              </header>
              ...
              <section className="space-y-3">
                <section className="p-3 bg-[#f8fafc] rounded-lg">
                  <section className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs text-[#6b6b6b] bg-[#e5e5e5] px-2 py-0.5 rounded">ObrigatÃ³rio</span>
                  </section>
                  <p className="text-xs text-[#6b6b6b]">NecessÃ¡rios para o funcionamento do site</p>
                </section>
                <section className="p-3 bg-[#f8fafc] rounded-lg">
                  <section className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-[#111111]">Cookies de preferÃªncias</span>
                    <Switch
                      checked={settings.cookieConsent}
                      onCheckedChange={(checked) => handleSettingChange('cookieConsent', checked)}
                    />
                  </section>
                  <p className="text-xs text-[#6b6b6b]">Lembram suas configuraÃ§Ãµes e preferÃªncias</p>
                </section>
              </section>
            </article>
          </TabsContent>
          ...
          <TabsContent value="conteudo" className="space-y-6">
            <article className="bg-white border border-[#e5e5e5] rounded-lg p-4 sm:p-6">
              <header className="flex items-center gap-3 mb-4">
                ...
                <section>
                  <h2 className="text-lg font-semibold text-[#111111]">ExibiÃ§Ã£o de ConteÃºdo</h2>
                  <p className="text-xs text-[#6b6b6b]">Como o conteÃºdo Ã© apresentado</p>
                </section>
              </header>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center justify-between">
                  <section>
                    ...
                    <p className="text-xs text-[#6b6b6b]">Carregar mais conteÃºdo automaticamente ao rolar</p>
                  </section>
                  <Switch
            ...
            <article className="bg-white border border-[#e5e5e5] rounded-lg p-4 sm:p-6">
              <header className="flex items-center gap-3 mb-4">
                ...
                <section>
                  <h2 className="text-lg font-semibold text-[#111111]">MÃ­dia</h2>
                  <p className="text-xs text-[#6b6b6b]">ConfiguraÃ§Ãµes de vÃ­deo e imagens</p>
                </section>
              </header>
              ...
              <ul className="space-y-4">
                <li className="flex items-center justify-between">
                  <section>
                    <p className="text-sm font-medium text-[#111111]">ReproduÃ§Ã£o automÃ¡tica de vÃ­deos</p>
                    <p className="text-xs text-[#6b6b6b]">Iniciar vÃ­deos automaticamente (com som desativado)</p>
                  </section>
                  <Switch
                ...
                <li className="flex items-center justify-between">
                  <section>
                    ...
                    <p className="text-xs text-[#6b6b6b]">Desative para economizar dados mÃ³veis</p>
                  </section>
                  <Switch
          ...
          <TabsContent value="dados" className="space-y-6">
            <article className="bg-white border border-[#e5e5e5] rounded-lg p-4 sm:p-6">
              <header className="flex items-center gap-3 mb-4">
                ...
                <section>
                  ...
                  <p className="text-xs text-[#6b6b6b]">Baixe uma cÃ³pia dos seus dados</p>
                </section>
              </header>
              ...
              <aside className="p-3 bg-[#f0fdf4] border border-[#86efac] rounded-lg mb-4">
                <section className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-[#166534]">
                    Seus dados sÃ£o seus. VocÃª pode exportÃ¡-los a qualquer momento.
                  </p>
                </section>
              </aside>
            ...
            <article className="bg-white border border-[#e5e5e5] rounded-lg p-4 sm:p-6">
              <header className="flex items-center gap-3 mb-4">
                ...
                <section>
                  <h2 className="text-lg font-semibold text-[#111111]">Restaurar PadrÃµes</h2>
                  <p className="text-xs text-[#6b6b6b]">Voltar configuraÃ§Ãµes ao estado inicial</p>
                </section>
              </header>
            ...
            <article className="bg-white border border-[#ef4444] rounded-lg p-4 sm:p-6">
              <header className="flex items-center gap-3 mb-4">
                ...
                <section>
                  ...
                  <p className="text-xs text-[#6b6b6b]">AÃ§Ãµes que nÃ£o podem ser desfeitas</p>
                </section>
              </header>
              ...
              <aside className="p-3 bg-[#fef2f2] border border-[#fecaca] rounded-lg mb-4">
                <section className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-[#7f1d1d]">
                    A exclusÃ£o de dados Ã© permanente. NÃ£o serÃ¡ possÃ­vel recuperar seus favoritos, histÃ³rico e configuraÃ§Ãµes.
                  </p>
                </section>
              </aside>
              ...
              <header className="flex items-start gap-2">
                ...
                <section>
                  ...
                  <p className="text-xs text-[#7f1d1d] mt-1">
                    Este Ã© um portal demonstrativo. Seus dados sÃ£o armazenados apenas no seu 
                    navegador (LocalStorage) e podem ser perdidos ao limpar o cache. 
                    NÃ£o hÃ¡ servidor backend - seus dados nÃ£o saem deste dispositivo.
                  </p>
                </section>
              </header>
            </aside>
        ...
        {/* BotÃ£o flutuante para salvar em mobile */}
        {hasChanges && (
        ...
        <Dialog open={showResetDialog} onOpenChange={setShowResetDialog}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Restaurar configuraÃ§Ãµes padrÃ£o?</DialogTitle>
              <DialogDescription>
                Todas as suas configuraÃ§Ãµes personalizadas serÃ£o perdidas e restauradas para o estado inicial.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
        ...
        <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Esta aÃ§Ã£o Ã© irreversÃ­vel. Todos os seus dados serÃ£o permanentemente removidos.
                <br /><br />
