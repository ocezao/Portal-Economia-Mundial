...
const openApiDocument = {
  ...
  paths: {
    ...
    '/uploads': {
          ...
          content: {
            'multipart/form-data': {
              schema: {
                ...
                properties: {
                  ...
                  focusKeywords: { type: 'string', description: 'Lista CSV de keywords da imagem' },
            ...
            'application/json': {
              schema: {
                ...
                required: ['base64'],
                properties: {
                  base64: { type: 'string', description: 'Aceita base64 puro ou data URL.' },
      ...
      patch: {
        summary: 'Atualiza metadados editoriais da imagem registrada',
        requestBody: {
          required: true,
          content: {
            'application/json': {
