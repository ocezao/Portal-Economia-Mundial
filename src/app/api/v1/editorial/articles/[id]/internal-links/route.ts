import { getEditorialInternalLinkSuggestions } from '@/lib/server/editorialIntelligence';
...
export async function GET(
  ...
  try {
    ...
    const result = await getEditorialInternalLinkSuggestions(auth.admin, id, getLookupMode(req), getLimit(req));
