import { getEditorialSeoAudit } from '@/lib/server/editorialIntelligence';
...
export async function GET(
  ...
  try {
    ...
    const audit = await getEditorialSeoAudit(auth.admin, id, getLookupMode(req));
    return editorialSuccess(audit);
  } catch (error) {
