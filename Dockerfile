...
# If you only set them at runtime (docker-compose environment), the browser bundle
# will not have them and features like Supabase Auth will appear "not configured".
